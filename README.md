...
GitHub sometimes fails to render Jupyter notebooks in the web preview and shows only `An error occurred`. The following HTML version is provided as a stable browser-readable rendering with code cells and recorded outputs in notebook order:
